# Google Ads Campaign Brief — Solaren Event Staff Nashville, TN

> **Created by:** Parker (@ppc-paid-media-specialist) · 2026-04-03
> **Status:** Ready for Implementation
> **Flight:** Apr 18–25, 2026 (7-day burst)
...
| Field | Value |
|-------|-------|
| **Duplicate From** | `p-b2c-google-search-us-bofu-bau-nashville-hospitality--eg--` *(confirm ID in Google Ads)* |
| **New Campaign Name** | `p-b2c-google-search-us-bofu-bau-nashville-hospitality-hiring-event-04252026` |
| **Campaign Type** | Google Search |
| **Objective** | Hiring Event Registrations |
...
| Field | Value |
|-------|-------|
| **Duplicate From** | `p-b2c-google-app-us-bofu-bau-nashville-hospitality--eg--` *(confirm ID in Google Ads)* |
| **New Campaign Name** | `p-b2c-google-app-us-bofu-bau-nashville-hospitality-hiring-event-04252026` |
| **Campaign Type** | App (UAC) |
| **Objective** | App Downloads → Event Registration |
| **Start Date** | 2026-04-18 |
| **End Date** | 2026-04-25 (event day) |
| **Daily Budget** | $50/day |
| **Total Budget** | ~$350 |
...
| Field | Value |
|-------|-------|
| **Event Date** | April 25th, 2026 (Saturday) |
| **Shift** | 4:00 AM – 2:00 PM |
| **Venue** | Nashville, TN *(exact location TBD — confirm with Solaren/event coordinator)* |
| **Client** | Solaren |
| **Role** | Event Staff (Traffic & Road Closure Management) |
| **Pay Rate** | $17.50/hr |
| **Age Requirement** | 18+ |

### Responsibilities
- Coordinate and manage traffic flow during the event
- Provide drivers with clear rerouting directions
- Enforce and monitor road closures throughout the event
- Identify and promptly report issues to area supervisors

### Requirements
- 18+ years of age
- Strong communication and customer service skills
- Ability to follow instructions and work as part of a team
- Comfortable standing and being on your feet for long shifts
- Reliable and punctual

### Key Benefits
- Weekly Pay or Same Day Pay available
- $75 referral bonus *(terms and conditions apply)*
- Flexible shifts through Indeed Flex
- Work exciting, large-scale events
...
```
https://indeedflex.com/find-jobs/hospitality/lp-event-staff/?utm_source=google&utm_medium=cpc&link_value=syft://jobs/browse/500202&employer=NA&metro=nashville&role=event-staff&utm_campaign=us-solaren-event-staff-nashville-tn
```
...
- `p---hospitality--` *(if exists)* → update RSA with event copy

**ADD new ad group:**
- `Event Staff — Nashville` → event-specific keywords + RSA

---

## Keywords to Add

### Ad Group: `Event Staff — Nashville`
```
[EXACT] event staff nashville
[EXACT] event staff jobs nashville tn
[EXACT] hiring event nashville
[EXACT] traffic control event staff nashville
[EXACT] event staff hiring now
[PHRASE] event staff jobs nashville
[PHRASE] hiring event nashville tn
[PHRASE] event staffing nashville
[PHRASE] traffic control jobs nashville
[PHRASE] outdoor event staff nashville
[PHRASE] road closure event staff nashville
[BROAD] event staff hiring nashville tennessee
[BROAD] get hired on the spot nashville
```

### Add to `p---generic_immediate--`
```
[PHRASE] immediate event staff nashville
[PHRASE] event staff jobs hiring now nashville
[PHRASE] outdoor event jobs nashville
[EXACT] event staff nashville tn
[PHRASE] hospitality event jobs nashville
```

### Add to `p---hospitality--` *(if exists)*
```
[PHRASE] hospitality event staff nashville
[PHRASE] event staff jobs nashville tennessee
[EXACT] event staff near me nashville
...
> **Display Paths:** path1 = `Event-Staff` | path2 = `Nashville`

### Headlines (use all 15)

| # | Headline | Chars |
|---|----------|-------|
| 1 | Event Staff — April 25th | 24 |
| 2 | Nashville, TN · Sat Apr 25 | 26 |
| 3 | $17.50/Hr Event Staff Jobs | 27 |
| 4 | Instant Job Offer on the Spot | 29 |
| 5 | Traffic & Event Crew Wanted | 27 |
| 6 | Walk In, Walk Out Employed | 26 |
| 7 | Same Day Pay Available | 22 |
| 8 | 4AM–2PM Saturday Shift | 22 |
| 9 | Meet Recruiters Face to Face | 28 |
| 10 | Indeed Flex Hiring Event | 24 |
| 11 | Road Closure Event Staff | 24 |
| 12 | Large-Scale Events · Nashville | 30 |
| 13 | Get Hired Today — Apr 25 | 24 |
...
| # | Headline | Chars |
|---|----------|-------|
| 1 | Download App & Attend Apr 25 | 28 |
| 2 | Hiring Event — April 25th | 25 |
| 3 | Event Staff Jobs $17.50/Hr | 26 |
| 4 | Nashville, TN · Sat Apr 25 | 26 |
| 5 | Get Hired at Our Live Event | 27 |

### Descriptions

| # | Description | Chars |
|---|-------------|-------|
| 1 | Download Indeed Flex & register for our Apr 25 event staff shift in Nashville, TN. | 82 |
| 2 | Event staff $17.50/hr. Work a large-scale Nashville event Sat Apr 25, 4am–2pm. | 78 |
| 3 | Download the app, sign up & attend our hiring event. Instant offers on April 25. | 80 |
| 4 | Same Day Pay, $75 referral bonus. Attend our event staff shift Apr 25 in Nashville. | 83 |
| 5 | Indeed Flex is hiring Event Staff in Nashville, TN. Register for Apr 25 today. | 78 |
...
- [ ] Add new ad group: `Event Staff — Nashville`
- [ ] Add event keywords to `Event Staff — Nashville` ad group
- [ ] Add event staff keywords to `p---generic_immediate--` and `p---hospitality--`
